<template>
    ...
    <Layout :prv_page="[{ name: 'Products', link: '/admin/products' }, { name: 'Edit' }]">
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0">
                <div class="card-title m-0"><h3 class="fw-bolder m-0">Edit Product</h3></div>
            </div>
                    ...
                    <div class="row g-8 mb-8">
                        ...
                        <div class="col-lg-6">
                            ...
                            <img
                                ...
                                alt="Product image"
                                style="max-width: 120px; margin-top: 0.5rem; border-radius: 8px;"
                            >
                        </div>
                    </div>
                </div>
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <button type="submit" class="btn" style="background-color: #5A8F3C; color: #fff" :disabled="form.processing">Save Changes</button>
                </div>
            </form>
        </div>
    </Layout>
