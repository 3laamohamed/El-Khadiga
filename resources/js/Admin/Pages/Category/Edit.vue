<template>
    <Head title="تعديل فئة" />
    <Layout :prv_page="[
        {'name' : 'الفئات',  'link' : '/admin/category'},
        {'name' : 'تعديل فئة'},
        ]">
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">تعديل فئة</h3>
            </div>
        </div>
            ...
            <div class="card-body border-top p-9">
                <div class="row g-8 mb-8">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div v-else>
                                <img :src="props.category.icon_url" style="width: 80px;border-radius: 5px;">
                            </div>
                    </div>
                </div>
            </div>
