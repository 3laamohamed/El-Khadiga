    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">إضافة ميزة</h3>
            </div>
        </div>
            ...
            <div class="card-body border-top p-9">
                <div class="row g-8 mb-8">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control"    v-model="form.disc_ar"></textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control"    v-model="form.disc_en"></textarea>
                    ...
                    <div class="col-lg-6">
                            ...
                            <div v-if="form.errors.cover" v-text="form.errors.cover"
