<template>
    <Head title="تعديل ميزة" />
    <Layout :prv_page="[
        {'name' : 'الميزات الإضافية',  'link' : '/admin/services'},
        {'name' : 'تعديل ميزة'},
        ]">
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">تعديل ميزة</h3>
            </div>
        </div>
            ...
            <div class="card-body border-top p-9">
                <div class="row g-8 mb-8">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea rows="3" class="form-control"    v-model="form.disc_ar"></textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea rows="3" class="form-control"    v-model="form.disc_en"></textarea>
                    ...
                    <div class="col-lg-6">
                            <label class="fs-6 form-label fw-bolder text-dark required">صورة الغلاف</label>
                            <input type="file" class="form-control" @change="onFileChangeCover" />
                            <div v-if="form.errors.cover" v-text="form.errors.cover" class="text-danger text-xs mt-1"></div>
                            <div v-if="form.cover">
                                <img :src="form.cover_url" style="width: 80px;border-radius: 5px;">
                            </div>
                            <div v-else>
                                <img :src="props.service.cover_url" style="width: 80px;border-radius: 5px;">
                            </div>
                    </div>
                </div>
            </div>
