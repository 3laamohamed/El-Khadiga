    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">مزايا إضافية</h3>
            </div>
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-rounded table-row-bordered border gy-3 gs-3">
                    ...
                    <tbody>
                    <tr v-for="(item,index) in additionals.data" :key="item.id" :class="{'table-active': index % 2 !== 0 }">
            ...
            <Pagination :links="additionals.links" />
        </div>
    </div>
    </Layout>
