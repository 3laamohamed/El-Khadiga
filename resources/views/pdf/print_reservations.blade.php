    ...
    <div>
        <div style="float: right; width: 30%;text-align: right;" align="right">
            <p class="orderid" style="margin: 10px; float:left; font-size: 12px"><strong>
                    {{$reservation->shop->name ??''}}</strong></p>
            <p class="orderid" style="margin:2.5px; float:left; font-size: 14px">{{$reservation->shop->mobile}}</p>
            <p class="orderid" style="margin: 2.5px; float:left; font-size: 14px">{{$reservation->shop->email}}</p>
